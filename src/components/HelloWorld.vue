		...
		<div id="heroCarousel" class="carousel slide carousel-fade"
			...
			<div class="carousel-inner" role="listbox">
				...
				<div class="carousel-item active"
					style="background-image: url('https://www.agoda.com/wp-content/uploads/2018/10/Experience-Seoul_attractions_Gyeongbokgung-Palace.jpg');">
					<div class="carousel-container">
						<div class="carousel-content container">
							...
							<p class="animate__animated animate__fadeInUp">
								여행을 떠나고 싶으신가요? <br /> 당신에게 맞는 여행지를 발견해보세요.
							</p>
							<a href="./tour-plan"
								class="btn-get-started animate__animated animate__fadeInUp scrollto">나만의
								여행 계획</a>
						</div>
					</div>
				</div>
				...
				<div class="carousel-item"
					style="background-image: url('https://t1.daumcdn.net/cfile/tistory/252FA9345225669928');">
					<div class="carousel-container">
						<div class="carousel-content container">
							<h2 class="animate__animated animate__fadeInDown">우리나라의
								아름다움을 음미해보세요.</h2>
							<p class="animate__animated animate__fadeInUp">생각지도 못한 곳을 발견할
								수도 있어요.</p>
							<a href="./region-search"
								class="btn-get-started animate__animated animate__fadeInUp scrollto">지역별
								여행지 찾아보기</a>
						</div>
					</div>
				</div>
				...
				<!-- Slide 3 -->
				<div class="carousel-item"
					style="background-image: url('http://www.traveldaily.co.kr/news/photo/202004/24938_32935_151.jpg');">
					<div class="carousel-container">
						<div class="carousel-content container">
							<h2 class="animate__animated animate__fadeInDown">
								각자의 핫플레이스를 자랑해요.
							</h2>
							<p class="animate__animated animate__fadeInUp">자신만의 아지트를 공유하고
								같이 이야기 나눠봐요.</p>
							<a href="./hot-place"
								class="btn-get-started animate__animated animate__fadeInUp scrollto">구경가기</a>
						</div>
					</div>
				</div>
			</div>
